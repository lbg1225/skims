...
@Entity
@Table(name="aud_bnc_rtx_apldo_seqc") //--방카영수증청약서채번
@Getter
@NoArgsConstructor // (access = AccessLevel.PROTECTED) // AccessLevel.PUBLIC
@EqualsAndHashCode // (of = {"email","name"}, callSuper = true, onParam = @__(@NonNull))
@ToString //(exclude = "password") // exclude 속성을 사용하면, 특정 필드를 toString() 결과에서 제외
/*--------------------------------------------
Page<AudBncRtxApldoSeqc>findByRtxKndcdAndRtxSsYrAndRtxBkSno(String rtxKndcd, String rtxSsYr, String rtxBkSno, Pageable pageable); // FindPK
------------------------------------------*/
@IdClass(AudBncRtxApldoSeqcPK.class)
public class AudBncRtxApldoSeqc {
    @Id //  String
    ...
    @Builder
    public AudBncRtxApldoSeqc(String rtxKndcd, String rtxSsYr, String rtxBkSno, BigDecimal ssCt, String plyno, String crrnm, BigDecimal prm, String admBrOrgcd, String dhBrOrgcd, String dhStfno, Date o1SeqcDt, String o1SeqcHms, String o1SsStfno, Date o2SeqcDt, String o2SeqcHms, String o2SsStfno, Date o3SeqcDt, String o3SeqcHms, String o3SsStfno, String rtxMfgYn, String inpUsrId, Date inpDthms, String mdfUsrId, Date mdfDthms) {
