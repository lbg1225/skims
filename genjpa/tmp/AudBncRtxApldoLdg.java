...
@Entity
@Table(name="aud_bnc_rtx_apldo_ldg") //--방카영수증청약서원장
@Getter
@NoArgsConstructor // (access = AccessLevel.PROTECTED) // AccessLevel.PUBLIC
@EqualsAndHashCode // (of = {"email","name"}, callSuper = true, onParam = @__(@NonNull))
@ToString //(exclude = "password") // exclude 속성을 사용하면, 특정 필드를 toString() 결과에서 제외
/*--------------------------------------------
Page<AudBncRtxApldoLdg>findByRtxKndcdAndRtxSsYrAndRtxBkSno(String rtxKndcd, String rtxSsYr, String rtxBkSno, Pageable pageable); // FindPK
------------------------------------------*/
@IdClass(AudBncRtxApldoLdgPK.class)
public class AudBncRtxApldoLdg {
    @Id //  String
    ...
    @Builder
    public AudBncRtxApldoLdg(String rtxKndcd, String rtxSsYr, String rtxBkSno, Date rtxIsdt, String tgnrtOrgcd, Date tgnrtOrgMfgdt, Date tgnrtOrgRcdt, String admOrgcd, Date admOrgMfgdt, String admOrgMfgStfno, Date admOrgRcdt, String dhBrOrgcd, Date dhBrMfgdt, Date dhBrRcdt, String admBrRcStfno, String dhgncOrgcd, Date dhgncMfgdt, Date dhgncRcdt, String rtxStFlgcd, Date rtxStFlgdt, String rcYn, String rtnBfRtxStFlgcd, Date rtnBfRtxStFlgdt, Date rtndt, String rtnRgtStfno, Date reRtndt, String rrtnRgtStfno, String rtnAryn, Date rtnApdt, String rtnApRgtStfno, String rrtnAryn, Date rrtnApdt, String rrtnApRgtStfno, String rtrsCn, Date rtdt, String rtRgtStfno, String crrnm, Date rpdt, Date rvdt, BigDecimal prm, BigDecimal pymSeq, String pymYymm, Date grcdt, String rtxPlyno, String rtxPlynoDgre, String rsBzmno, Date insStrdt, Date insNddt, String insImcd, Date crtdt, String orgcrYr, Date orgcrInsEndt, Date orgcrPymDudt, BigDecimal orgcrPrm, String orgCrrnm, String orgcrTlno, String orgcrPstno, String orgcrAdr, String dhStfno, String inpUsrId, Date inpDthms, String mdfUsrId, Date mdfDthms) {
